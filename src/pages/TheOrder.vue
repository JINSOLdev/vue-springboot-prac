      ...
      <main>
        ...
        <div class="row g-5">
          <div class="col-md-5 col-lg-4 order-md-last">
            ...
            <div class="text-center total-price">합계 {{ lib.getNumberFormatted(computedPrice) }}원</div>
          </div>
          <div class="col-md-7 col-lg-8">
            ...
            <div class="needs-validation" novalidate="">
              ...
              <button class="w-100 btn btn-primary btn-lg" @click="submit()">결제</button>
            </div>
          </div>
        </div>
      </main>
...
export default {
  setup() {
    ...
    const submit = () => {
      ...
      axios.post("/api/orders", args, {withCredentials: true}).then(() => {
